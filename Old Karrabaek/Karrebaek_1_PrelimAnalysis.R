...
#Set to 25mm capture difference between behaviours (not currently being used)
#  Frozen Event Min. Time- 3s  (not currently being used)
#  Transitions time Int.- 7s  (not currently being used)



## K.1.3 Preliminary behavioural data exploration ----
...
# other available variables not analyzed here: 
#     avespeed_tot
#     aveacceler
#     frozenevents
#     timefrozen_tot
...
## K.1.4 Processing behavioural database for analysis ----
